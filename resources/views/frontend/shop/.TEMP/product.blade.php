                                            ...
                                            @if($product->thumbnail)
                                                    @if($product->thumbnail)
                                                        <div class="slide" data-thumb="{!! $product->thumbnail !!}" style="width: 413px; float: left; display: block;">
                                                            <a href="{!!  !!}" title="{!! $product->name !!}" data-lightbox="gallery-item">
                                                                <img src="{!! $product->thumbnail !!}" alt="{!! $product->name !!} image" draggable="false">
                                                            </a>
                                                        </div>
                                                    @endif
                                                    @if($product->thumbnail2)
                                                        <div class="slide" data-thumb="{!!  !!}" style="width: 413px; float: left; display: block;">
                                                            <a href="{!! $product->thumbnail !!}" title="{!! $product->second_image_label !!} - Front View" data-lightbox="gallery-item">
                                                                <img src="{!! $product->thumbnail !!}" alt="{!! $product->second_image_label !!} image" draggable="false">
                                                            </a>
                                                        </div>
                                                    @endif
                                                    @foreach($product->photos as $photo)
                                                        @if($product->third_image)
                                                            <div class="slide" data-thumb="{!! $photo->photo_src !!}" style="width: 413px; float: left; display: block;">
                                                                <a href="" title="{!! $photo->alt !!}" data-lightbox="gallery-item">
                                                                    <img src="{!! $photo->photo_src !!}" alt="{!! $photo->alt !!} image" draggable="false">
                                                                </a>
                                                            </div>
                                                        @endif
                                                    @endforeach
